...
Para Windows, muitas ferramentas estão disponiveis para a conversão de scripts para executáveis. Por exemplo, __py2exe__, pode ser usado para empacotar um script Python, junto com as bibliotecas que ele requere, em um único executável.<br>__PyInstaller__ e __cx_Freeze__ servem para o mesmo propósito.
