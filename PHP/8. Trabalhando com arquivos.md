...
__r__: Abre o arquivo apenas para leitura.<br>
__w__: Abre o arquivo apenas para escrita. Apaga os conteúdos do arquivo ou cria um novo arquivo se ele não existir.<br>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5NTMyMjIzMF19
-->